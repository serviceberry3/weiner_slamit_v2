...
public:
    ...
    Frame(const cv::Mat &imGray, const cv::Mat &imRgb, const double &timeStamp, ORBextractor* extractor,ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, Posenet posenet, TfLiteInterpreter* interpreter);
